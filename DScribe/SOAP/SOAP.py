# -*- coding: utf-8 -*-
"""
Created on Mon Aug  2 08:40:34 2021
...
soap_water = soap.create(structures, n_jobs=1)

print("Number of values for SOAP descriptor: {}".format(len(soap_water[0])))

print("SOAP vector for first water molecule:")
print(soap_water[0])
